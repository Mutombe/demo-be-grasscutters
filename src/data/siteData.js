...
const siteData = {
  business: {
    ...
    legalName: "BE GRASSCUTTERS",
    tagline: "Professional Lawn Care You Can Trust",
    description: "BE Grasscutters provides professional lawn mowing, garden maintenance, and landscaping services across Harare. Reliable, affordable, and always on time -- we keep Harare's gardens looking their best.",
    phone: "+263 77 286 5385",
    phoneRaw: "+263772865385",
    whatsappNumber: "263772865385",
    email: "begrasscutters@gmail.com",
    address: "5 Douglas Dr, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 3.8,
    ratingRounded: 4,
    ...
    cookieConsentKey: "be-grasscutters-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "BE", logoLine2: "GRASSCUTTERS" },

  hero: {
    badge: "Harare's Reliable Lawn Care Team",
    titleParts: [
      { text: "WHERE LAWNS " },
      { text: "LOOK", highlight: true },
      { text: " THEIR BEST." },
    ],
    subtitle: "1,000+ properties maintained. Professional lawn care and garden maintenance that keeps your outdoor space pristine, week after week, without you lifting a finger.",
  ...
  about: {
    ...
    story: [
      "BE Grasscutters started in 2019 on Douglas Drive with a simple promise: show up on time, do excellent work, and charge a fair price. That approach has earned us over 1,000 regular clients across Harare.",
      "From weekly mowing to full landscape overhauls, our team of trained gardeners treats every property like their own. Reliable, affordable, and always thorough.",
    ],
    values: [
    ...
    team: [
      { name: "The Founder", role: "Managing Director", bio: "With over a decade of industry experience, our founder built BE GRASSCUTTERS on a foundation of quality and trust.", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&q=80" },
  ...
  contact: {
    ...
    branches: [
      { name: "Harare Office", address: "5 Douglas Dr, Harare, Zimbabwe", phone: "+263 77 286 5385", email: "begrasscutters@gmail.com" },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hello BE GRASSCUTTERS! I would like to discuss a project.",
    backgroundImage: "https://images.unsplash.com/photo-1558904541-efa843a96f01?w=1920&q=85",
  },

  footer: {
    description: "BE Grasscutters provides professional lawn mowing, garden maintenance, and landscaping services across Harare. Reliable,...",
    copyright: "BE GRASSCUTTERS",
  },
};
