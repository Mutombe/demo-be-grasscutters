            ...
            >
              <h1
                ...
                style={{
                  ...
                  fontWeight: line === 'GRASSCUTTERS.' ? 700 : 300,
                }}
              >
                {line}
              </h1>
...
function ServiceMarquee() {
  const routes = ['MOWING', 'EDGING', 'TRIMMING', 'WEEDING', 'FERTILIZING', 'AERATION', 'SEEDING', 'TOP DRESSING', 'PEST CONTROL'];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-gold-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Services</p>
              <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
                Lawn <span className="text-gold-500">Care</span>
              </h2>
            </div>
            <Link
              to="/services"
    ...
    <section ref={containerRef} className="bg-[#0a2a1a] py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[3px] bg-gold-500 mb-6" />
            <p className="text-gold-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Work</p>
            <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
              Perfectly <span className="text-gold-500">Manicured</span>
            </h2>
          </div>
          <Link
            to="/projects"
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Professional Mowing', desc: 'Commercial-grade mowers for clean, even cuts. Stripes optional. Your lawn, your style.' },
    { title: 'Hedge & Edge Work', desc: 'Precision hedge trimming, lawn edging, and border maintenance for a crisp, tidy finish.' },
    { title: 'Regular Schedules', desc: 'Weekly or fortnightly visits. We show up on time, every time. No reminders needed.' },
    { title: 'Garden Cleanup', desc: 'Leaf removal, debris clearing, and general garden tidying. We leave your property spotless.' },
  ];
